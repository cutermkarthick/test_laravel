...
@section('content')
	...
	{!!  Form::open(['url'=>'spmfro' , 'class'=>'form', 'method' => 'post']) !!}
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="6">
		<tr>
			<td><span class="heading"><b>QSPL Boeing Specs</b></span></td>
	...
	<table style="table-layout: fixed" width="100%" border=0 cellpadding=3 cellspacing=2 bgcolor="#DFDEDF" class="table table-bordered">
		<tr  bgcolor="#FFCC00">
            ...
            <td  bgcolor="#EEEFEE"><span class="tabletext"><b>Process Code</b></span></td>
            ...
            <td  bgcolor="#EEEFEE"><span class="tabletext"><b>Specification #</b></span></td>
            <td  bgcolor="#EEEFEE"><span class="tabletext"><b>Nomenclature</b></span></td>
            <td  bgcolor="#EEEFEE"><span class="tabletext"><b>Doc Notes</b></span></td>
            <td  bgcolor="#EEEFEE"><span class="tabletext"><b>Nadcap Commodity</b></span></td>
