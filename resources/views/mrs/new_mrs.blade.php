...
@section('content')
	...
	<table border=0 bgcolor="#DFDEDF" width=100% cellspacing=1 cellpadding=3 class="table table-bordered">
		...
		<tr bgcolor="#FFFFFF">
            ...
            <td><span class="labeltext"><input type="text" name="issue" id="issue" size=20 value=""></span></td>
        </tr>

        <tr bgcolor="#FFFFFF">
          <td><span class="labeltext"><p align="left">Customer</p></font></td>
          <td><input type="text" name="customer" id="customer" size=20 value="">
          </td>
          <td><span class="labeltext"><p align="left">Date</p></font></td>
          <td><input type="text" name="date" id="date" size=20 value="" >
          </td>
        </tr>

        <tr bgcolor="#FFFFFF">
          <td><span class="labeltext"><p align="left">Scope</p></font></td>
          <td><textarea name="scope" id="scope" cols="50" rows="3"></textarea></td>
          <td><span class="labeltext"><p align="left">Responsibility</p></font></td>
          <td><textarea name="response" id="response" cols="50" rows="3"></textarea>
        </tr>
        
        <tr bgcolor="#FFFFFF">
            <td><span class="labeltext"><p align="left">Reference</p></font></td>
            <td><textarea name="reference" id="reference" cols="50" rows="3"></textarea></td>
            <td></td>
            <td colspan="3"></td>
        </tr>
  	...
  	<table id="myTable" width=100% border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF" class="table table-bordered">
		...
		<tr>
			...
			<input type="hidden"  name="{{$ps_recnum}}" id="{{$ps_recnum}}" value="" size="10%">
	...
	<input type="submit" size="60" value="Submit"  class="btn btn-default" onclick="javascript: return check_req_fields4New()"/>
