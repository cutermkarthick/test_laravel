	...
	<table border=0 bgcolor="#DFDEDF" width=100% cellspacing=1 cellpadding=3 class="table table-bordered">
      ...
      <select name="pin_type" id="pin_type">
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td><input type="text" name="customer" size=20 value="{{$myrow->customer}}"></td>
        </tr>
        
        <tr bgcolor="#FFFFFF">
            <td><span class="labeltext"><p align="left">Part Issue</p></span></td>
            <td><input type="text" name="part_issue" size=20 value="{{$myrow->part_issue}}"></td>        
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td><input type="text" name="drawing_num" size=20 value="{{$myrow->drawing_num}}"></td>
